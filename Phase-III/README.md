# The Evolution of Todo - Phase III

> A modern, spec-driven full-stack todo application with AI chatbot built with Next.js, FastAPI, Cohere AI, and Neon PostgreSQL
...
- **Natural Language Commands** - Create, update, delete tasks using conversational English/Urdu
- **MCP Tool Integration** - 5 MCP tools for task management (add_task, list_tasks, toggle_task, update_task, delete_task)
- **Cohere AI** - Using Command-R+ model for intelligent task understanding
- **Conversation Persistence** - All conversations stored with full history
- **Due Date Parsing** - Intelligent due date extraction and formatting
- **Multi-Language Support** - English, Urdu, and Roman Urdu support
...
- **AI Integration** - Cohere API for conversational task management
...
5. Copy and paste into `COHERE_API_KEY` in your `.env` file
...
#### Chat (Phase-III)
- `POST /api/chat` - Send message to AI chatbot for task management
