...
```
DATABASE_URL=postgresql://neondb_owner:npg_8Hm3izLIqPcD@ep-nameless-bush-a7lr42ke-pooler.ap-southeast-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require
...
**Important:** After deploying frontend to Vercel, update `FRONTEND_URL` to your Vercel URL.
